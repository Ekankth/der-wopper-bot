...
def cmd_start(update: Update, _context: CallbackContext) -> None:
    update.effective_message.reply_text(
        ...
        f'\n/join → for joining the game'
        f'\n/leave → for leaving (for leaving the game)'
        f'\n/random → for choosing a random person'
        f'\n/true_random → choosing any random person'
        f'\n/choose @username → choose via username'
